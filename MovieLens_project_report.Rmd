...
The performance is evaluated using the Root Mean Square Error (RMSE), defined as: $$RMSE = \sqrt{\frac{1}{N} \sum_{u,i} (\hat{y}_{u,i} - y_{u,i})^2}$$ Where $y_{u,i}$ is the actual rating and $\hat{y}_{u,i}$ is our prediction.
